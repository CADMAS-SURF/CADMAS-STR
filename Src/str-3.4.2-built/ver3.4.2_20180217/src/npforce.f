      SUBROUTINE NPFORCE(FTI,FCK,FCD,FCM,FCMD,FCP,EPS,S,MGP,KK,NNOD
     &                  ,NESTF,RR,GRID,IELM,NM,AMAT,RODA,BARD,BVEC,D,UG
     &                  ,VG,PPND,DT1,DT2,ITER,ITER2,IDYN,ITO)
     ...
     &               ,AMAT(5,IMAT))
        ...
        IF( ITYP == 2 .AND. I5 == 1 ) 
     &    CALL EFRCP(FCP,GRID,PPND,IELM(8,I),NNP,ITO)
